  ...
  return (
    <hgroup>
      <section className="flex justify-center relative">
        <figure className="absolute lg:left-52 left-10 md:left-20 lg:bottom-12 bottom-20">
        ...
        <figure className="absolute lg:right-52 right-12 md:right-20 lg:top-12 top-20">
          <img src={quotes} alt="quotes" className="lg:h-8 lg:w-8 w-7 h-7" />
        </figure>
      </section>
